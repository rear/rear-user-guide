...
-  [\#3178 Issue](./2024-03-12.3178.issue.closed.md) `closed`: rear does not recognize nvme when trying to format it with "rear format"
...
-  [\#3208 Issue](./2024-04-19.3208.issue.closed.md) `closed`: BACKUP=CDM missing security certificate for replica Rubrik instance
...
-  [\#3226 Issue](./2024-05-21.3226.issue.closed.md) `closed`: Deprecate mailing list, chat and discussions
- [\#3226 Issue](./2024-05-21.3226.issue.open.md) `open`: Deprecate mailing list, chat and discussions
-  [\#3227 Issue](./2024-05-21.3227.issue.closed.md) `closed`: What comes after SYSLINUX? Support modern PXE booting via iPXE
...
-  [\#3234 Issue](./2024-05-27.3234.issue.closed.md) `closed`: Replace direct usage of /etc/rear-release with RECOVERY\_MODE
...
-  [\#3247 Issue](./2024-06-13.3247.issue.closed.md) `closed`: How to setup ReaR for Fedora-Cloud-Base-Generic.x86\_64-40-VERSION.qcow2
...
-  [\#3257 Issue](./2024-06-19.3257.issue.closed.md) `closed`: OUTPUT option to only have a grub/efi entry but no ISO?
...
-  [\#3259 Issue](./2024-06-21.3259.issue.closed.md) `closed`: ReaR must not carelessly 'source' files
...
-  [\#3264 Issue](./2024-07-02.3264.issue.closed.md) `closed`: Automatic release notes creation as a WIKI page
...
-  [\#3355 PR](./2024-12-04.3355.pr.merged.md) `merged`: Storing and reading Self Encrypted Disk (SED
...
-  [\#3359 Issue](./2024-12-10.3359.issue.closed.md) `closed`: BACKUP\_PROG=rsync: Is it possible to backup and restore to/from an NFS share that has root squash enabled?
...
-  [\#3360 Issue](./2024-12-11.3360.issue.closed.md) `closed`: Officially support Alma Linux, Rocky Linux and Oracle Linux as RHEL clones
...
-  [\#3447 PR](./2025-04-05.3447.pr.merged.md) `merged`: Extend the umount\_mountpoint function to try normal, forced and lazy umounts
...
-  [\#3475 Issue](./2025-05-28.3475.issue.closed.md) `closed`: Add RHEL 10 and clones support
...
-  [\#3480 Issue](./2025-06-16.3480.issue.closed.md) `closed`: Do we actually need `dbus` in the rescue environment?
-  [\#3480 Issue](./2025-06-16.3480.issue.open.md) `open`: Do we actually need `dbus` in the rescue environment?
-  [\#3481 Issue](./2025-06-16.3481.issue.closed.md) `closed`: Only stale issues marked with label "waiting for info"
...
-  [\#3509 Issue](./2025-08-11.3509.issue.closed.md) `closed`: Convert ASCIIDOC man-page and User Guide to Markdown
...
-  [\#3513 Issue](./2025-08-21.3513.issue.closed.md) `closed`: ReaR - rsync recover very slow
...
-  [\#3515 PR](./2025-08-25.3515.pr.merged.md) `merged`: Add support for `dbus-broker`
...
-  [\#3523 Issue](./2025-09-24.3523.issue.closed.md) `closed`: EXTERNAL\_RESTORE does not run
...
-  [\#3536 PR](./2025-11-20.3536.pr.merged.md) `merged`: Rbme backup
-  [\#3536 PR](./2025-11-20.3536.pr.open.md) `open`: Rbme backup
-  [\#3537 Issue](./2025-11-24.3537.issue.closed.md) `closed`: The systemd service file refers to the obsolete BindTo= option
-  [\#3537 Issue](./2025-11-24.3537.issue.open.md) `open`: The systemd service file refers to the obsolete BindTo= option
-  [\#3538 Issue](./2025-11-24.3538.issue.closed.md) `closed`: rear recover on SLES15 SP5: BUILD\_DIR/outputfs not empty or umounted
-  [\#3539 PR](./2025-11-26.3539.pr.merged.md) `merged`: SourceStage(
-  [\#3540 PR](./2025-12-01.3540.pr.merged.md) `merged`: Renamed BindTo within systemd/system/serial-getty@.service into BindsTo
-  [\#3541 Issue](./2025-12-01.3541.issue.closed.md) `closed`: Recover with duplicity broken in ReaR 2.6 and higher
-  [\#3541 Issue](./2025-12-01.3541.issue.open.md) `open`: Recover with duplicity broken in ReaR 2.6 and higher
-  [\#3542 Issue](./2025-12-03.3542.issue.closed.md) `closed`: Unable to Recover via USB + External HDD | error: no server is specified
-  [\#3543 Issue](./2025-12-04.3543.issue.open.md) `open`: local.conf configuration for system with no local storage. Using iSCSI.
-  [\#3544 Issue](./2025-12-09.3544.issue.open.md) `open`: "rear recover" disk values consistency check (prerequirement to fix MIGRATION\_MODE issues
-  [\#3545 Issue](./2025-12-11.3545.issue.open.md) `open`: "rear recover" btrfs filesytem upgrade issue with 'space\_cache' mount option
-  [\#3546 PR](./2025-12-11.3546.pr.merged.md) `merged`: make duplicity work well again + sanity checks added
-  [\#3547 PR](./2026-01-01.3547.pr.merged.md) `merged`: Bump actions/upload-artifact from 5.0.0 to 6.0.0
-  [\#3548 PR](./2026-01-01.3548.pr.merged.md) `merged`: Bump redhat-plumbers-in-action/differential-shellcheck from 5.5.5 to 5.5.6
-  [\#3549 PR](./2026-01-01.3549.pr.merged.md) `merged`: Bump actions/checkout from 5 to 6
-  [\#3550 Issue](./2026-01-09.3550.issue.closed.md) `closed`: UEFI Boot: Kernel panic with previous "No file system could mount root, tried:"
-  [\#3551 Issue](./2026-01-09.3551.issue.open.md) `open`: Automatically include firmware files for the kernel modules in the recovery system
-  [\#3552 Issue](./2026-01-12.3552.issue.open.md) `open`: add support loongarch64
-  [\#3553 PR](./2026-01-12.3553.pr.open.md) `open`: Automatically include firmware files for the kernel modules in the recovery system
-  [\#3554 Issue](./2026-01-14.3554.issue.open.md) `open`: TSM: support for a different dsmc optfile via 'dsmc ... -optfile=$TSM\_DSMC\_OPTFILE'
...
-  [\#3561 Issue](./2026-02-05.3561.issue.closed.md) `closed`: Add PARTUUID recovery
-  [\#3562 PR](./2026-02-05.3562.pr.merged.md) `merged`: Partuuid recovery
-  [\#3563 Issue](./2026-02-11.3563.issue.open.md) `open`: how to pass custom config parameter with rear command
-  [\#3564 Issue](./2026-02-13.3564.issue.closed.md) `closed`: Add grub2 Boot Loader Specification (BLS
-  [\#3565 PR](./2026-02-13.3565.pr.merged.md) `merged`: Add GRUB2-BLS support
-  [\#3566 Issue](./2026-02-17.3566.issue.closed.md) `closed`: SLE16 BTRFS recovery fails: usr/share/snapper/config-templates/default missing
-  [\#3567 Issue](./2026-02-19.3567.issue.closed.md) `closed`: openSUSE Tumbleweed no ssh and recovery fails: RPC portmapper 'rpcbind' unavailable
-  [\#3568 PR](./2026-02-19.3568.pr.merged.md) `merged`: Copy installation-helper for BTRFS to the rescue system
-  [\#3569 PR](./2026-02-19.3569.pr.merged.md) `merged`: Changes to recover openSUSE Tumbleweed / SLES16
-  [\#3570 PR](./2026-02-21.3570.pr.merged.md) `merged`: Use get\_disk\_size to show current disk size
-  [\#3571 PR](./2026-02-21.3571.pr.merged.md) `merged`: Apply XFS options from configs in non-debug mode
-  [\#3572 PR](./2026-02-24.3572.pr.merged.md) `merged`: borg enhancements
-  [\#3573 Issue](./2026-02-26.3573.issue.closed.md) `closed`: rsyslog.service fails to start
-  [\#3574 PR](./2026-02-27.3574.pr.merged.md) `merged`: \#3560 adjust return code of bprestore
-  [\#3575 PR](./2026-02-27.3575.pr.merged.md) `merged`: Update Linux.conf to make vi working with SLES 16
-  [\#3576 PR](./2026-03-01.3576.pr.merged.md) `merged`: Bump actions/upload-artifact from 6.0.0 to 7.0.0
-  [\#3577 PR](./2026-03-04.3577.pr.merged.md) `merged`: Check direct usage of /etc/rear-release
-  [\#3578 Issue](./2026-03-05.3578.issue.open.md) `open`: Default boot entry is not preserved because grubenv is removed during recovery
-  [\#3579 PR](./2026-03-06.3579.pr.merged.md) `merged`: Include rsyslog loadable modules in LIBS
-  [\#3580 Issue](./2026-03-09.3580.issue.closed.md) `closed`: Restore a backup without a specific folder
-  [\#3581 PR](./2026-03-10.3581.pr.merged.md) `merged`: grubenv should not be moved away by default
-  [\#3582 Issue](./2026-03-13.3582.issue.closed.md) `closed`: /etc/mdadm/mdadm.conf missing in rescue image
-  [\#3583 PR](./2026-03-13.3583.pr.merged.md) `merged`: Save copy of /etc/mdadm/mdadm.conf file
-  [\#3584 PR](./2026-03-16.3584.pr.merged.md) `merged`: Remove deprecated BuildRoot tag from RPM spec file
-  [\#3585 Issue](./2026-03-16.3585.issue.closed.md) `closed`: Lower default ISO\_FILE\_SIZE\_LIMIT for PowerPC Systems
-  [\#3586 PR](./2026-03-17.3586.pr.merged.md) `merged`: More clear LIBS comments in Linux.conf
-  [\#3587 PR](./2026-03-20.3587.pr.merged.md) `merged`: In default.conf remove outdated info about partial UEFI support
-  [\#3588 Issue](./2026-03-20.3588.issue.open.md) `open`: Remove 'ebiso' support in ReaR 3.0
-  [\#3589 Issue](./2026-03-23.3589.issue.open.md) `open`: RFC: Could we set ISO\_FILE\_SIZE\_LIMIT=0 ?
-  [\#3590 Issue](./2026-03-24.3590.issue.open.md) `open`: Migrating Digitalocean droplet to Hetzner VPS: hangs on booting rescue media via kexec
-  [\#3591 PR](./2026-03-24.3591.pr.open.md) `open`: Save and reset GRUB environment block when env\_block is used
-  [\#3592 PR](./2026-03-26.3592.pr.merged.md) `merged`: ISO: mark ISO filesystem labels as write protected
-  [\#3593 PR](./2026-03-27.3593.pr.open.md) `open`: Various `systemd` and `getty` related improvements
-  [\#3594 PR](./2026-03-28.3594.pr.merged.md) `merged`: docs: add iSCSI devices section to user guide
-  [\#3595 Issue](./2026-03-29.3595.issue.open.md) `open`: no keyboard response at rescue-system login-prompt on MacBookPro
-  [\#3596 Issue](./2026-03-30.3596.issue.open.md) `open`: Unable to create rescue/backup on XFS excluding BTRFS RAID mountpoint
