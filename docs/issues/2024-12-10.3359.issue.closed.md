# [\#3359 Issue](https://github.com/rear/rear/issues/3359) `closed`: BACKUP\_PROG=rsync: Is it possible to backup and restore to/from an NFS share that has root squash enabled?
...
--stats
--log-file="*L**O**G*<sub>*D*</sub>*I**R*/*r**s**y**n**c*−HOSTNAME.log")  
...
#### <img src="https://avatars.githubusercontent.com/u/888633?u=cdaeb31efcc0048d3619651aa18dd4b76e636b21&v=4" width="50">[gdha](https://github.com/gdha) commented at [2026-02-04 08:13](https://github.com/rear/rear/issues/3359#issuecomment-3845977074):

@scook207 okay to close this issue?
