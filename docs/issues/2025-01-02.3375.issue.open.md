# [\#3375 Issue](https://github.com/rear/rear/issues/3375) `open`: unpacking of archive failed on file /usr/share/rear/skel/default/var/run: cpio: File from package already exists as a directory in system
