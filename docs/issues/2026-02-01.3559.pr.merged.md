# [\#3559 PR](https://github.com/rear/rear/pull/3559) `merged`: Bump actions/checkout from 5.0.1 to 6.0.2

**Labels**: `dependencies`, `github_actions`

#### <img src="https://avatars.githubusercontent.com/in/29110?v=4" width="50">[dependabot](https://github.com/apps/dependabot) opened issue at [2026-02-01 11:01](https://github.com/rear/rear/pull/3559):
...
<li>See full diff in <a href="https://github.com/actions/checkout/compare/v5.0.1...v6.0.2">compare view</a></li>
</ul>
</details>
<br />

[![Dependabot compatibility
score](https://dependabot-badges.githubapp.com/badges/compatibility_score?dependency-name=actions/checkout&package-manager=github_actions&previous-version=5.0.1&new-version=6.0.2)](https://docs.github.com/en/github/managing-security-vulnerabilities/about-dependabot-security-updates#about-compatibility-scores)
