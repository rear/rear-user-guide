[\#3051 PR](https://github.com/rear/rear/pull/3051) `merged`: Bump actions/checkout from 3 to 4
===============================================================================================
...
#### <img src="https://avatars.githubusercontent.com/u/1788608?u=925fc54e2ce01551392622446ece427f51e2f0ce&v=4" width="50">[jsmeix](https://github.com/jsmeix) commented at [2023-10-27 12:34](https://github.com/rear/rear/pull/3051#issuecomment-1782840401):
...
What is see at  
[https://github.com/rear/rear/pull/3051/files](https://github.com/rear/rear/pull/3051/files)  
...
and also e.g.
[https://github.com/cory-miller](https://github.com/cory-miller)  
is not someone who I know.  
This does not look like official GitHub software  
and/or an official GitHub employee.

#### <img src="https://avatars.githubusercontent.com/u/101384?v=4" width="50">[schlomo](https://github.com/schlomo) commented at [2023-10-27 14:05](https://github.com/rear/rear/pull/3051#issuecomment-1782977720):

@jsmeix Dependabot is a service run by GitHub that can automatically
submit PRs for dependency upgrades. Please see
...
In
[https://github.com/rear/rear/blob/master/.github/dependabot.yml](https://github.com/rear/rear/blob/master/.github/dependabot.yml)
we configured such Dependabot updates for the GitHub actions recipes and
their dependencies.
...
#### <img src="https://avatars.githubusercontent.com/u/101384?v=4" width="50">[schlomo](https://github.com/schlomo) commented at [2023-10-27 14:07](https://github.com/rear/rear/pull/3051#issuecomment-1782980320):

Ah, you noticed correctly the use of a version tag or a git SHA to refer
to the dependency, this is version pinning and also recommended best
practice. Dependabot can handle both, most people pin the major version
and trust the minor/patch updates blindly. Setting the SHA allows for
more human control over the dependency change, but I'd recommend that
only for situations where a human would actually want to look at it.

#### <img src="https://avatars.githubusercontent.com/u/1788608?u=925fc54e2ce01551392622446ece427f51e2f0ce&v=4" width="50">[jsmeix](https://github.com/jsmeix) commented at [2023-10-27 14:27](https://github.com/rear/rear/pull/3051#issuecomment-1783012187):
