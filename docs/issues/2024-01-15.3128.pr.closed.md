[\#3128 PR](https://github.com/rear/rear/pull/3128) `closed`: ErrorIfDeprecated when GRUB Legacy is used
========================================================================================================
...
> does Red Hat still need support for RHEL 6 in current ReaR master
