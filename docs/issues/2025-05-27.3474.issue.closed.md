# [\#3474 Issue](https://github.com/rear/rear/issues/3474) `closed`: Migrate LUKS disk as is, without setting a password phrase at the time of recovery
...
#### <img src="https://avatars.githubusercontent.com/u/1788608?u=925fc54e2ce01551392622446ece427f51e2f0ce&v=4" width="50">[jsmeix](https://github.com/jsmeix) commented at [2025-06-26 13:08](https://github.com/rear/rear/issues/3474#issuecomment-3008440119):

@prontok  
setting the LUKS password in disklayout.conf via
...
because when you run in the ReaR recovery system in debugscript mode

    rear -D recover

its log file with the LUKS password value in it  
will be stored into the recreated system by  
wrapup/default/990\_copy\_logfile.sh  
which should be reasonably safe
...
<https://github.com/rear/rear/blob/master/usr/share/rear/wrapup/default/990_copy_logfile.sh#L21>  
nevertheless - better safe than sorry  
so don't have secret values in the log by default  
(if really needed run sbin/rear with `--expose-secrets`).

#### <img src="https://avatars.githubusercontent.com/u/1788608?u=925fc54e2ce01551392622446ece427f51e2f0ce&v=4" width="50">[jsmeix](https://github.com/jsmeix) commented at [2025-07-11 13:22](https://github.com/rear/rear/issues/3474#issuecomment-3062332299):

<https://github.com/rear/rear/issues/3483>  
should be sufficiently fixed in ReaR GitHub master code.

See the section  
"Testing current ReaR upstream GitHub master code" in  
<https://en.opensuse.org/SDB:Disaster_Recovery>  
how you could try out the current ReaR upstream GitHub master  
code from within a separated directory without conflicts  
with a normally installed ReaR version:  
