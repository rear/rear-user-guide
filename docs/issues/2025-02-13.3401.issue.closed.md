# [\#3401 Issue](https://github.com/rear/rear/issues/3401) `closed`: longhorn iscsi devices are network based devices and should not be listed to recreate in disklayout.conf
...
Reported at RedHat:
<https://access.redhat.com/support/cases/#/case/04073965>

#### <img src="https://avatars.githubusercontent.com/u/1788608?u=925fc54e2ce01551392622446ece427f51e2f0ce&v=4" width="50">[jsmeix](https://github.com/jsmeix) commented at [2025-07-29 06:55](https://github.com/rear/rear/issues/3401#issuecomment-3130949681):

@gdha  
I think when an issue is "fixed / solved / done"  
since a longer time it can and should be closed  
so I dare to "just close" it right now.  
If I was wrong please reopen it.
